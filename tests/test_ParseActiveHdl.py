...
activehdl_compile_patterns = [
    ...
    (RunCategory.ERROR, "Error: COMP96_0015: some_file.vhd : (46, 14): ';' expected.")
]
...
activehdl_test_patterns = [
    ...
    (RunCategory.ERROR, 'RUNTIME: Fatal Error: RUNTIME_0048 full_adder_pass_tb.vhd (49): Cannot open file "missing_file.txt"'),
...
def test_activehdl_compile_rules() -> None:
    ...
    # Parse the text using the ActiveHDL compile rules
...
def test_activehdl_test_rules() -> None:
    ...
    # Parse the text using the ActiveHDL test rules
